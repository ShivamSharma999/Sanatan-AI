...
function bootstrap() {
  ...
  if(uAg.includes("Android") || uAg.includes("iOS")) {
    ($("meta[property='og:image']") as HTMLMetaElement).content = "https://sanatan-ai.vercel.app/Resources/images/logo.png";
    ($("meta[name='icon']") as HTMLMetaElement).content = "Resources/images/logo.png"
    let icon = ($('link[rel="icon"]') as HTMLLinkElement);
    icon.type = "image/png";
 ...
 */
export function edit(editButton: HTMLButtonElement, i: number): undefined {
