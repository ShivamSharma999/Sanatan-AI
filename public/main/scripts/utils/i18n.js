...
export const locales = {
  en: {
    ...
    termsList4: '<b>Sanatan AI\'s Responses</b> are powered by Gemini',
    termsList5: 'Animated Icons are from <a href="https://lordicon.com">LordIcon</a>',
    ...
    loginJourney: 'Login with Google to begin your journey.',
    almostThere: 'Almost There!',
    tellAboutYou: 'Tell about you.',
    enterNameLabel: 'Enter your Name:',
    startAi: 'Start AI',
    searchExplore: 'Search and explore Bhagavad Gita verses',
    ...
    voice: 'Voice',
    send: 'Send',
    messagePlaceholder: 'Ask a question or share your thoughts...',
    responsesPowered: 'Responses are powered by <b>Google Gemini</b>. AI may make mistakes, so please verify replies.',
    deleteAllMessages: 'Delete All Messages',
    deleteAllMessagesTooltip: 'Delete all messages',
  ...
  hi: {
    ...
    termsList4: '<b>Sanatan AI के उत्तर</b> Gemini द्वारा समर्थित हैं',
    termsList5: 'एनिमेटेड आइकन <a href="https://lordicon.com">LordIcon</a> से हैं',
    ...
    loginJourney: 'अपनी यात्रा शुरू करने के लिए Google से लॉगिन करें।',
    almostThere: 'लगभग हो गया!',
    tellAboutYou: 'अपने बारे में बताएं।',
    enterNameLabel: 'अपना नाम दर्ज करें:',
    startAi: 'AI शुरू करें',
    searchExplore: 'भगवद गीता के श्लोकों को खोजें, समझें और एक्सप्लोर करें',
    stopResponding: 'उत्तर देना बंद करें',
    ...
    voice: 'वॉइस',
    send: 'भेजें',
    messagePlaceholder: 'कृपया कोई प्रश्न पूछें या अपना विचार साझा करें...',
    responsesPowered: '<b>Google Gemini</b> द्वारा उत्तर प्रदत हैं। एआई गलतियाँ कर सकता है, इसलिए कृपया उत्तरों की पुष्टि करें।',
    deleteAllMessages: 'सभी संदेश हटाएं',
    deleteAllMessagesTooltip: 'सभी संदेश हटाएँ',
    ...
    completingAuthentication: 'प्रमाणीकरण पूरा किया जा रहा है...',
    loggedInAs: '{name} के रूप में लॉग इन हुआ',
    authenticationFailed: 'प्रमाणीकरण विफल हुआ। कृपया पुनः प्रयास करें।',
...
export function translatePage() {
  document.querySelectorAll('[data-i18n]').forEach((element) => {
    ...
    } else if (element.dataset.i18nPlaceholder !== undefined) {
      element.placeholder = text;
    } else if (element.dataset.i18nValue !== undefined) {
      element.value = text;
...
export function setLocale(locale) {
  ...
  localStorage.setItem('sanatan_locale', currentLocale);
...
export function initI18n() {
  const savedLocale = localStorage.getItem('sanatan_locale');
