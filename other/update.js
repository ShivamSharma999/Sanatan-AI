 ...
 * @returns { string | Object } Updated version or updated packageJSON
 */
...
function updatePackage(path) {
    ...
    const updatedPackage = updateVersion(pkg.version, false, false, pkg);
    fs.writeFileSync(path, JSON.stringify(updatedPackage, null, 2));
   return console.log("Successfully updated package version..");
    } catch (e) {
